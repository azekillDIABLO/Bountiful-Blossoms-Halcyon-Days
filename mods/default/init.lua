...
minetest.register_on_joinplayer(function(player)
	local cb = function(player)
		minetest.chat_send_player(player:get_player_name(), "Hello, "..player:get_player_name().."! Welcome to the [Bountiful Blossoms, Halcyon Days...] subgame.")
	end
	minetest.after(2.0, cb, player)
end)

-- Set the survival inventory and hotbar
...
minetest.register_node("default:forest_grass", {
	description = "Forest grass",
	tiles ={"default_forest_grass.png", "default_dirt.png",
...
minetest.register_node("default:oil_flowing", {
	...
	liquid_alternative_source = "default:oil",
	post_effect_color = {a = 103, r = 30, g = 60, b = 90},
	groups = {acid = 3, liquid = 3},
})
	

minetest.register_node("default:oil", {
	description = "Oil",
	drawtype = "liquid",
	tiles = {"default_oil.png"},
	walkable = false,
...
function default.grow_tree(data, a, pos, is_apple_tree, seed)
	--[[
		...
		and in defaults that have saplings; both are deprecated but not
		replaced yet
	]]--
