...
local tnt_radius = tonumber(minetest.setting_get("tnt_radius") or 5)
...
local function add_effects(pos, radius, drops)
	minetest.add_particlespawner(
			30, --amount
			0.1, --time
			{x=pos.x-tnt_radius/1.5, y=pos.y-tnt_radius/1.5, z=pos.z-tnt_radius/1.5}, --minpos
			{x=pos.x+tnt_radius/1.5, y=pos.y+tnt_radius/1.5, z=pos.z+tnt_radius/1.5}, --maxpos
			{x=-0, y=-0, z=-0}, --minvel
			{x=0, y=0, z=0}, --maxvel
			{x=-0.2,y=0.2,z=-0.2}, --minacc
			{x=0.2,y=0.2,z=0.2}, --maxacc
			1, --minexptime
			1, --maxexptime
			40, --minsize
			65, --maxsize
			false, --collisiondetection
			"tnt_boom.png" --texture
		)
		--smoke
		minetest.add_particlespawner(
			10, --amount
			...
			{x=-0, y=-0, z=-0}, --minvel
			{x=0, y=0, z=0}, --maxvel
			{x=-0.5,y=0.2,z=-0.5}, --minacc
			{x=0.5,y=0.2,z=0.5}, --maxacc
			1, --minexptime
			5, --maxexptime
			15, --minsize
			45, --maxsize
	...
	for name, stack in pairs(drops) do
		...
		amount = 20,
		time = 0.1,
		minpos = {x=pos.x-tnt_radius, y=pos.y-tnt_radius, z=pos.z-tnt_radius},
		maxpos = {x=pos.x+tnt_radius, y=pos.y+tnt_radius, z=pos.z+tnt_radius},
		minvel = {x = -10, y = 5, z = -10},
		maxvel = {x = 10, y = 5,  z = 10},
		minacc = {x = -12, y = -15, z = -12},
		maxacc = {x = 12, y = -15, z = 12},
		minexptime = 2,
		maxexptime = 2,
		minsize = radius,
		maxsize = radius * 3,
		texture = "tnt_blast.png",
		collisiondetection = false, -- explode trough everything as a projectile
	})
end
